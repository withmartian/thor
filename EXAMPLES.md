...
| [scaling-laws](https://github.com/withmartian/scaling-laws) | Scaling laws for Transformer Programs — weights that decompile into human-readable Python | Light-touch adoption: the shared project-wide docs used to keep terminology and document discipline consistent across the work. |
